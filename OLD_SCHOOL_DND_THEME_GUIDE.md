...
```css
background-image: 
  linear-gradient(45deg, transparent 25%, rgba(74, 61, 42, 0.1) 25%, rgba(74, 61, 42, 0.1) 75%, transparent 75%),
  linear-gradient(-45deg, transparent 25%, rgba(74, 61, 42, 0.1) 25%, rgba(74, 61, 42, 0.1) 75%, transparent 75%);
...
```css
background-image: 
  linear-gradient(45deg, transparent 25%, rgba(74, 61, 42, 0.15) 25%, rgba(74, 61, 42, 0.15) 75%, transparent 75%),
  linear-gradient(-45deg, transparent 25%, rgba(74, 61, 42, 0.15) 25%, rgba(74, 61, 42, 0.15) 75%, transparent 75%);
...
- **Golden Lettering**: 
```css
background: linear-gradient(45deg, var(--dnd-color-treasure), #f4e4a6, var(--dnd-color-treasure));
